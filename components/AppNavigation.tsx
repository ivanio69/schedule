 ...
 return <>
  ...
  <nav className="app-navigation" aria-label="Основные разделы">
   ...
   <style jsx global>{`
    ...
    .app-navigation{position:sticky;top:12px;z-index:100;display:grid;grid-template-columns:1fr 1.25fr 1.1fr 1fr;gap:4px;width:min(calc(100% - 32px),760px);margin:12px auto -18px;padding:4px;border:1px solid #27272c;border-radius:14px;background:rgba(17,17,20,.88);backdrop-filter:blur(14px)}
