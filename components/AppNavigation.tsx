 ...
 return <>
  ...
  <nav className="app-navigation" aria-label="Основные разделы">
   ...
   <style jsx global>{`
    ...
    .app-navigation{position:sticky;top:12px;z-index:100;display:grid;grid-template-columns:1fr 1.25fr 1fr;gap:4px;width:min(calc(100% - 32px),620px);margin:12px auto -18px;padding:4px;border:1px solid #27272c;border-radius:14px;background:rgba(17,17,20,.88);backdrop-filter:blur(14px)}
    ...
    @media(max-width:600px){.app-navigation{width:calc(100% - 20px)}.app-navigation a{min-height:42px;font-size:11px}.dashboard-logout{top:64px;right:10px}}
   `}</style>
  </nav>
 </>;
}