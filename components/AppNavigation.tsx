...
export default function AppNavigation(){
 ...
 useEffect(()=>{
  ...
  return()=>{window.removeEventListener("storage",sync);window.removeEventListener("schedule-auth-change",sync);window.clearInterval(authPoll);window.removeEventListener("scroll",onScroll)};
 },[]);
