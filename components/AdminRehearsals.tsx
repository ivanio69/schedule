...
type Rehearsal = { id: string; subject: string; responsible: string; timeStart: string; timeEnd: string; isGlobal?: boolean };
...
export default function AdminRehearsals(){
 ...
 return <><AdminHeading title="Репетиции" description="Общие репетиции, которые видит вся группа."/>
