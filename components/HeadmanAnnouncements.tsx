...
export default function HeadmanAnnouncements({ people }: { people:Person[] }){
  ...
  return <section className={styles.root}>
    <header className={styles.sectionHead}><h2>Объявления</h2><div><span>{activeCount} активных</span><button type="button" onClick={()=>void load()} disabled={loading||busy} aria-label="Обновить объявления">↻</button></div></header>
