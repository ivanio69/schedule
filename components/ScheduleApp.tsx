...
export default function ScheduleApp() {
  ...
  const toggleRehearsalParticipant = (name: string) => setRehearsalParticipants(current => current.includes(name) ? current.filter(item => item !== name) : [...current, name]);
  ...
  const beginRehearsalEdit = (item: Rehearsal) => {
    ...
    setRehearsalParticipants(item.participants);
