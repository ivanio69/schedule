...
export default function ScheduleApp() {
  ...
  const ownRehearsalId = useMemo(() => typeof window === "undefined" ? "" : window.localStorage.getItem(REHEARSAL_USER_KEY) ?? "", []);
