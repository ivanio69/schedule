...
export default function SettingsPage() {
  ...
  const colorSettings = [
    {key:"appAccent" as const,label:"Акцент приложения",description:"Фон, UI, кнопки и активные состояния"},
    {key:"rehearsalAccent" as const,label:"Репетиции",description:"По умолчанию — янтарный"},
    {key:"individualAccent" as const,label:"Индивидуальные",description:"По умолчанию — розовый"},
    {key:"seminarAccent" as const,label:"Семинары",description:"По умолчанию — фиолетовый"},
  ];
