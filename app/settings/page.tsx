...
export default function SettingsPage() {
  ...
  const colorSettings = [
    {key:"appAccent" as const,label:"Акцент приложения",description:"Кнопки, навигация и активные состояния"},
    {key:"rehearsalAccent" as const,label:"Репетиции",description:"Карточки, участники и редактор репетиций"},
    {key:"individualAccent" as const,label:"Индивидуальные",description:"Индивидуальные занятия и запись"},
    {key:"seminarAccent" as const,label:"Семинары",description:"Темы, мои семинары и действия"},
  ];
