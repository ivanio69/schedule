...
export default function SettingsPage() {
  ...
  const colorSettings = [
    {key:"appAccent" as const,label:"Акцент приложения",description:appearance.appAccentMode==="time"?"Ручной цвет сохранён; сейчас работает автоматический режим":"Фон, UI, кнопки и активные состояния",defaultClass:""},
