...
export default function SettingsPage() {
  ...
  const [notificationPreferences,setNotificationPreferences]=useState<Record<string,boolean>>({seminars:true,seminarParticipants:true,individuals:true,schedule:true});
